...
=======
	...
	$scope.test = function(){
		...
		$http.get("http://localhost:3412/ClassDemo3Srv/ok",{params: {sname: '', password:'********'}},xhr)
	...
	$scope.openAddressesPopover = function($event){
>>>>>>> 20769d1358d65a457048a47161136eb64a518b93
	...
	$scope.showEditCardPopup = function(card) {
		...
		var editCardPopup = $ionicPopup.show({
			...
			buttons: [
				{ text: 'Close' },
				{ text: 'Delete',
					type: 'delete-button', // type: 'icon-left ion-trash-a delete-button',
					onTap: function(e) {
						// return $scope.data;
			  		}
				},
		...
		editCardPopup.then(function(res) {
		  if(res) { console.log('hacer algo cuando apreta ADD con los datos llenos'); }
		});
	};
	...
	$scope.SavePost = function(){
		...
		$http.get(
			"http://localhost:3412/ClassDemo3Srv/addFeedPost",
			{params: {description: comments, businessid: $scope.data.businessid }},
			xhr)
		.success(function(data){
			var r = data;
			$ionicPopup.alert({
...
=======
					onTap: function(e) { // return $scope.data;
					}
				},
				{ text: 'Edit',
					onTap: function(e) { // return $scope.data;
